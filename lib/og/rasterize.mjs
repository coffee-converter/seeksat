...
import { SYMBOLS_FONT_BUFFER } from "./symbols-font-embed.mjs";

// Arimo/Exo 2 + a planet-symbol fallback (☿♀♂♃♄). resvg searches every
// loaded buffer for any glyph the primary font lacks.
const ALL_FONT_BUFFERS = [...FONT_BUFFERS, SYMBOLS_FONT_BUFFER];
...
export async function rasterizeSvg(svg, { width = 1200 } = {}) {
  ...
  const resvg = new Resvg(svg, {
    ...
    font: { loadSystemFonts: false, fontBuffers: ALL_FONT_BUFFERS, defaultFontFamily: "Arimo" },
  });
