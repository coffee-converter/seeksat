...
// there's nothing to search for, so dismiss the loading screen
// immediately rather than letting it sit through the 12-second
// safety-net timeout, and start the clock animating at 1× from real
// time so the globe shows live earth rotation behind the empty
// "Add observer" panel. As soon as the user adds an observer,
// rerunSearchIfActive() will kick off the first real search +
// jump-to-pass logic.
