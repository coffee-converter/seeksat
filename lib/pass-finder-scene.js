...
// Race-fix: if TlePanel's auto-fetch already landed before we got
// here (Cesium viewer slow → scene init delayed past the fetch),
// the subscription above never fires for that initial value. Pick
// it up now.
