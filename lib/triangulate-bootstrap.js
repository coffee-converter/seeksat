...
// Truth-block text rendering migrated to ResultPanel.tsx; bootstrap
// keeps only the Cesium-entity side (truth point, orbit track, miss
// dashed line) plus the store mirror for state.truthPos.
