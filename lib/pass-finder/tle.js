...
//
// Primary: tle.ivanstanojevic.me (a CORS-enabled mirror that's
// reliably reachable from the browser). Falls back to Celestrak
// (canonical source, but frequently times out or 403s from browser
// origins so it's the secondary). Returns { name, line1, line2 }
// or null if both fail.
