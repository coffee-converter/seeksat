// lib/pass-finder-bootstrap.js — wrap-and-mount port of legacy/pass-finder.js.
//
// Exports `initPassFinder(container)` — async, runs once after Cesium
// is loaded and PassFinderApp's JSX is mounted. The DOM element IDs
// referenced here MUST match what PassFinderApp.tsx renders (mirrors
// legacy/passes.html). Same wrap-and-mount strategy as the triangulate
// bootstrap.
...
export async function initPassFinder(container) {
const viewer = makeViewer(container);
wireSimTime(viewer);
